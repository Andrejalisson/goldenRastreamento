...
@section('corpo')
<section class="page-title-block text-center" style="background: #222222 url(../images/background/page-title-assistencia.jpg) center center no-repeat fixed">
    <div class="container">
        <h2>Assistência Veicular</h2>
    </div>
</section>
